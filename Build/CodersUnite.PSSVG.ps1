...
svg -content $(
    ...
    # svg.text -X 10% -Y 50% -Text '⩈' -FontSize 4.2em -DominantBaseline middle -Fill '#4488FF' -Style "font-family:'$fontName'" @commonParameters
    # svg.text -X 87.5% -Y 50% -Text '⩈' -FontSize 4.2em -DominantBaseline middle -Fill '#4488FF' -Style "font-family:'$fontName'" @commonParameters
    ...
    svg.text -X 25%  -FontSize 4.2em -FontFamily sans-serif @commonParameters -DominantBaseline 'middle' -TextAnchor 'right' -Style "font-family:'$fontName'" @(
        # SVG.animate -Values '0%;50%;0%' -AttributeName 'x' -Dur 4.2s -RepeatCount indefinite
